        ...
        cards: [
          {
            ...
            content: "Quá độ lên chủ nghĩa xã hội bỏ qua chế độ tư bản chủ nghĩa là sự lựa chọn duy nhất đúng, khoa học, phản ánh đúng quy luật phát triển khách quan của cách mạng Việt Nam. Đây là sự lựa chọn dứt khoát và đúng đắn của Đảng, đáp ứng nguyện vọng của dân tộc và phù hợp với xu thế thời đại.",
            image: "/images/ca1.jpg"
          },
          {
            title: "2. Quan niệm về 'Bỏ qua chế độ tư bản chủ nghĩa' (Đại hội IX)",
            content: "Bỏ qua việc xác lập vị trí thống trị của quan hệ sản xuất và kiến trúc thượng tầng tư bản chủ nghĩa. Không có nghĩa là đoạn tuyệt hoàn toàn mà phải tiếp thu, kế thừa những thành tựu mà nhân loại đã đạt được, đặc biệt là về khoa học, công nghệ và quản lý để phát triển xã hội.",
            image: "/images/ca2.jpg"
          },
          {
            title: "3. Biểu hiện của việc 'Bỏ qua' về mặt kinh tế",
            content: "Trong thời kỳ quá độ, vẫn còn nhiều hình thức sở hữu và thành phần kinh tế. Tuy nhiên, sở hữu tư nhân tư bản chủ nghĩa không chiếm vai trò chủ đạo. Phân phối theo lao động vẫn là chủ đạo, nhưng vẫn còn phân phối theo mức độ đóng góp và quỹ phúc lợi xã hội.",
            image: "/images/ca3.jpg"
          },
          {
            title: "4. Tính chất của quá trình quá độ",
            content: "Là tạo ra sự biến đổi về chất của xã hội trên tất cả các lĩnh vực. Là sự nghiệp rất khó khăn, phức tạp, lâu dài với nhiều chặng đường, nhiều hình thức tổ chức kinh tế, xã hội có tính chất quá độ.",
    ...
    subsections: [
      {
        ...
        cards: [
          ...
          },
          {
            ...
            content: "Dựa trên lực lượng sản xuất hiện đại và quan hệ sản xuất tiến bộ phù hợp",
          ...
          },
          {
            ...
            content: "Các dân tộc trong cộng đồng Việt Nam bình đẳng, đoàn kết, tôn trọng và giúp nhau cùng phát triển",
            image: "/images/dt6.jpg"
          },
          {
            title: "7. Nhà nước pháp quyền XHCN của nhân dân",
            content: "Nhà nước của nhân dân, do nhân dân, vì nhân dân do Đảng Cộng sản lãnh đạo",
            image: "/images/dt7.jpg"
          },
          {
            title: "8. Quan hệ hữu nghị và hợp tác quốc tế",
            content: "Có quan hệ hữu nghị và hợp tác với các nước trên thế giới",
        ...
        timeline: [
          {
            ...
            description: "Đảng ta đã xác định tám phương hướng cơ bản để xây dựng đất nước trong thời kỳ quá độ:",
          ...
          },
          {
            ...
            description: "Trong quá trình thực hiện tám phương hướng cơ bản, cần phải đặc biệt chú trọng nắm vững và giải quyết tốt các mối quan hệ lớn:",
...
const ContentSection = () => {
  ...
  const [selectedSubsection, setSelectedSubsection] = useState<{ sectionId: string; subsectionIndex: number } | null>(null);
      ...
      <div style={{ 
          ...
          >
            ...
            <div 
              style={{
                ...
                padding: '24px',
                cursor: 'pointer',
                backgroundColor: expandedSections.has(section.id) ? '#f8f8f8' : 'white',
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                <p style={{ 
                  ...
                  Bấm để {expandedSections.has(section.id) ? 'thu gọn' : 'xem chi tiết'}
                </p>
              </div>
              {section.image && (
              ...
              >
                ...
                <div style={{ 
                  ...
                  <div style={{
                    ...
                    backgroundImage: section.id === 'transition-socialism' 
                  ...
                  >
                    <div style={{
                      ...
                      {section.content.length > 0 && (
                        <ul style={{ listStyleType: 'disc', listStylePosition: 'inside', marginBottom: '24px' }}>
                          {section.content.map((item, index) => (
                            <li key={index} style={{ color: '#555', marginBottom: '8px', lineHeight: '1.6' }}>{item}</li>
                          ))}
                        </ul>
                      )}
                      
                      {/* Subsections for characteristics section */}
                      {section.subsections && section.id === 'characteristics' && (
                            ...
                            {section.subsections.map((subsection, index) => {
                              ...
                              return (
                                <motion.div
                                  ...
                                  onClick={() => openSubsectionModal(section.id, index)}
                                  style={{
                                    background: 'white',
                                    borderRadius: '16px',
                                    overflow: 'hidden',
                                ...
                                >
                                  ...
                                  <div style={{
                                    ...
                                    <div style={{
                                      ...
                                      {subsection.content && subsection.content.length > 0 && (
                                        <div style={{
                                          ...
                                          <span style={{ fontWeight: 'bold', color: '#333' }}>
                                            {subsection.content.length} nội dung chính
                                          </span>
                                        </div>
                                      )}
                                      {subsection.cards && subsection.cards.length > 0 && (
                                        <div style={{
                                          ...
                                          <span style={{ fontSize: '18px' }}>🎯</span>
                                          <span style={{ fontWeight: 'bold', color: '#333' }}>
                                            {subsection.cards.length} nội dung chi tiết
                                          </span>
                                        </div>
                                      )}
                                    </div>
                                    ...
                                    <p style={{
                                      ...
                                      {subsection.content && subsection.content[0]
                                        ? subsection.content[0].substring(0, 100) + '...'
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                          {section.subsections.map((subsection, index) => (
                            ...
                            >
                              ...
                              <div style={{
                                ...
                                <div style={{ flex: 1 }}>
                                  <h3 style={{
                                    ...
                                    color: '#d32f2f',
                                    margin: 0,
                                    textShadow: '0 1px 3px rgba(211, 47, 47, 0.1)'
                                  }}>
                                    {subsection.title}
                                  </h3>
                                </div>
                              ...
                              {/* Subsection Content */}
                              <div style={{ padding: '20px', background: 'linear-gradient(to bottom, rgba(255,255,255,0.9), rgba(211, 47, 47, 0.01))' }}>
                                <div style={{ marginBottom: '16px' }}>
                                  {subsection.content.map((item, itemIndex) => (
                                    <div key={itemIndex} style={{ marginBottom: '12px', lineHeight: '1.8' }}>
                                      {item.startsWith('-') ? (
                                        <div style={{ 
                                          marginLeft: '32px', 
                                          color: '#555',
                                    ...
                                    <div style={{ 
                                      ...
                                      {subsection.cards.map((card, idx) => {
                                        const colors = [
                                          ...
                                          { gradient: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', accent: '#f093fb' },
                                ...
                                {subsection.timeline && (
                                  <div style={{ marginTop: '32px', paddingTop: '32px', borderTop: '2px dashed #ddd' }}>
                                    <h4 style={{ 
                                      fontSize: '24px', 
                                      fontWeight: 'bold', 
                                      marginBottom: '32px', 
                                    ...
                                    <div style={{ 
                                      ...
                                      <div style={{
                                        ...
                                        bottom: '24px',
                                        width: '4px',
                                        background: 'linear-gradient(to bottom, #d32f2f 0%, #f44336 50%, #e91e63 100%)',
                                        borderRadius: '2px'
                                      }}></div>
                                      ...
                                      {subsection.timeline.map((event, idx) => (
                                        <motion.div 
                                          ...
                                          <motion.div
                                            ...
                                            style={{
                                              background: 'linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(211, 47, 47, 0.02) 100%)',
                                              borderRadius: '16px',
                                              padding: '24px',
                                          ...
                                          >
                                            ...
                                            {event.subItems && (
                                              <div style={{ 
                                                ...
                                                {event.subItems.map((subItem, subIdx) => (
                                                  <motion.div
                                                    key={subIdx}
                                                    initial={{ opacity: 0, y: 10 }}
                                                    animate={{ opacity: 1, y: 0 }}
                                                    transition={{ delay: idx * 0.3 + subIdx * 0.1, duration: 0.4 }}
            ...
            {[
              {
                ...
                description: 'Xóa bỏ chế độ khai thác, tạo xã hội bình đẳng nơi mọi người có quyền như nhau',
                color: '#d32f2f'
              },
              {
                title: 'Phát Triển Kinh Tế',
                description: 'Phát triển các lực lượng sản xuất, tăng năng suất lao động để nâng cao đời sống nhân dân',
                color: '#f44336'
              },
              {
                title: 'Tự Do Con Người',
                description: 'Giải phóng con người khỏi áp lực của chế độ tư bản, cho phép phát triển toàn diện',
                color: '#c62828'
              },
              {
                title: 'Hòa Bình Thế Giới',
                description: 'Xây dựng thế giới không có chiến tranh, khai thác, góp phần bảo vệ hòa bình toàn cầu',
                color: '#e53935'
              }
            ].map((item, idx) => (
              <motion.div
        ...
        >
          ...
          <div style={{
            ...
            {[
              { name: 'Hà Duy Tùng', mssv: 'SE17xxxx' },
        ...
        >
          ...
          <div style={{
            ...
            {[
              ...
              {
                title: 'Padlet',
                description: 'Nơi chia sẻ ý tưởng, dành giải công việc, trao đổi với nhau',
                icon: '🔗',
                color: '#FF1493'
              },
              {
              ...
              {
                title: 'Gemini',
                description: 'Tóm tắt ý chính từ giáo trình để chuẩn bị câu hỏi',
                icon: '✨',
                color: '#4CAF50'
              }
            ].map((tool, idx) => (
          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h3 style={{
                    ...
                    {(() => {
                      const section = sections.find(s => s.id === selectedSubsection.sectionId);
                      return section?.subsections?.[selectedSubsection.subsectionIndex]?.title;
                    })()}
                  </h3>
                  <button
                    onClick={closeSubsectionModal}
              ...
              <div style={{
                ...
                {(() => {
                  const section = sections.find(s => s.id === selectedSubsection.sectionId);
                  const subsection = section?.subsections?.[selectedSubsection.subsectionIndex];
                  ...
                  return (
                    <div>
                      ...
                      {/* Timeline */}
                      {subsection.timeline && subsection.timeline.length > 0 && (
                        <div style={{ marginTop: '32px' }}>
                                    ...
                                    <div style={{ 
                                      ...
                                      {event.subItems.map((subItem, subIdx) => (
                                        <motion.div
                                          ...
                                          initial={{ opacity: 0, y: 10 }}
                                          animate={{ opacity: 1, y: 0 }}
                                          transition={{ delay: 0.4 + idx * 0.3 + subIdx * 0.1, duration: 0.4 }}
                                          whileHover={{ scale: 1.02 }}
                                          style={{
                                            background: 'white',
                                            padding: '12px 16px',
                          ...
                          <div style={{ marginTop: '48px', width: '100%', overflowX: 'auto' }}>
                            <motion.div
                            ...
                            >
                              ...
                              <p style={{
                                ...
                                Đảng ta yêu cầu không được phiến diện, cực đoan, duy ý chí trong giải quyết các mối quan hệ này
                              </p>
                            </motion.div>
                            ...
                            <div style={{ 
                              ...
                              >
                                ...
                                {[
                                  { num: 1, title: 'Phát triển kinh tế nhanh, bền vững', desc: 'Giữ vững ổn định vĩ mô, đổi mới mô hình tăng trưởng, cơ cấu lại nền kinh tế. Đẩy mạnh CNH-HĐH.' },
                                  { num: 2, title: 'Hoàn thiện thể chế kinh tế', desc: 'Tiếp tục phát triển kinh tế thị trường định hướng xã hội chủ nghĩa; nâng cao hiệu lực, hiệu quả trong quản lý.' },
                                  { num: 3, title: 'Phát triển nguồn nhân lực', desc: 'Đổi mới căn bản, toàn diện giáo dục, đào tạo và đẩy mạnh ứng dụng khoa học công nghệ.' }
                                ].map((item, idx) => (
                                  <div key={idx} style={{ marginBottom: idx < 2 ? '16px' : 0 }}>
                                    <div style={{
                                      ...
                                      <strong style={{ fontSize: '14px', color: '#4caf50' }}>{item.title}:</strong>
                                    </div>
                                    <p style={{ 
                                      fontSize: '13px', 
                                      color: '#555', 
                              ...
                              >
                                ...
                                {[
                                  { num: 4, title: 'Xây dựng văn hóa', desc: 'Phát triển nền văn hóa Việt Nam tiên tiến, đậm đà bản sắc dân tộc, con người Việt Nam phát triển toàn diện.' },
                                  { num: 5, title: 'Quản lý xã hội và an sinh', desc: 'Đảm bảo an sinh xã hội, nâng cao phúc lợi xã hội; thực hiện tốt chính sách với người có công.' },
                                  { num: 6, title: 'Môi trường và khí hậu', desc: 'Khai thác, sử dụng hiệu quả tài nguyên thiên nhiên; bảo vệ môi trường; ứng phó với biến đổi khí hậu.' }
                                ].map((item, idx) => (
                                  <div key={idx} style={{ marginBottom: idx < 2 ? '16px' : 0 }}>
                                    <div style={{
                                      display: 'flex',
                                      ...
                                      <strong style={{ fontSize: '14px', color: '#2196f3' }}>{item.title}:</strong>
                                    </div>
                                    <p style={{ 
                                      fontSize: '13px', 
                                      color: '#555', 
                              ...
                              >
                                ...
                                {[
                                  { num: 7, title: 'Bảo vệ Tổ quốc', desc: 'Kiên quyết đấu tranh bảo vệ vững chắc độc lập, chủ quyền, thống nhất, toàn vẹn lãnh thổ của Tổ quốc.' },
                                  { num: 8, title: 'Đường lối đối ngoại', desc: 'Độc lập, tự chủ, đa phương hóa, đa dạng hóa, chủ động và tích cực hội nhập quốc tế.' },
                                  { num: 9, title: 'Phát huy dân chủ', desc: 'Hoàn thiện dân chủ xã hội chủ nghĩa và quyền làm chủ của nhân dân; củng cố đại đoàn kết dân tộc.' }
                                ].map((item, idx) => (
                                  <div key={idx} style={{ marginBottom: idx < 2 ? '16px' : 0 }}>
                                    <div style={{
                                      display: 'flex',
                                      ...
                                      <strong style={{ fontSize: '14px', color: '#ff9800' }}>{item.title}:</strong>
                                    </div>
                                    <p style={{ 
                                      fontSize: '13px', 
                                      color: '#555', 
                              ...
                              >
                                ...
                                {[
                                  { num: 10, title: 'Nhà nước pháp quyền', desc: 'Hoàn thiện Nhà nước pháp quyền xã hội chủ nghĩa, xây dựng bộ máy nhà nước tinh gọn, trong sạch, vững mạnh.' },
                                  { num: 11, title: 'Xây dựng Đảng', desc: 'Xây dựng Đảng trong sạch, vững mạnh, nâng cao năng lực lãnh đạo, tăng cường bản chất giai cấp công nhân.' },
                                  { num: 12, title: 'Xử lý các quan hệ lớn', desc: 'Quán triệt xử lý tốt 9 mối quan hệ lớn trong quá trình xây dựng chủ nghĩa xã hội.' }
                                ].map((item, idx) => (
                                  <div key={idx} style={{ marginBottom: idx < 2 ? '16px' : 0 }}>
                                    <div style={{
                                      display: 'flex',
                                      ...
                                      <strong style={{ fontSize: '14px', color: '#9c27b0' }}>{item.title}:</strong>
                                    </div>
                                    <p style={{ 
                                      fontSize: '13px', 
                                      color: '#555', 
